          ...
          <Row
            ...
            onPress={
              auth?.authenticated
                ...
                : (onOpenSignIn || openAccount || openProfile)
            }
            tone={colors.red}
            colors={colors}
          />
...
const s = StyleSheet.create({
  ...
  footer: { fontSize: 12, textAlign: "center", marginTop: 20, marginBottom: 16 },
  modalOverlay: {
    flex: 1,
  ...
  modalLabel: { fontSize: 13, fontWeight: "700", marginTop: 12, marginBottom: 6 },
  categoryGrid: {
    flexDirection: "row",
    flexWrap: "wrap",
    gap: 6,
  ...
  modalResult: { fontSize: 12.5, marginTop: 8, textAlign: "center" },
  modalSubmit: {
    height: 46,
    borderRadius: 9,
    alignItems: "center",

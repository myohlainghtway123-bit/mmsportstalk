...
const s = StyleSheet.create({
  ...
  inputWrap:{ minHeight:42, borderRadius:10, borderWidth:1, borderColor:C.border, backgroundColor:C.raised, marginTop:9, paddingHorizontal:10, flexDirection:"row", alignItems:"center", gap:7 },
  input:{ flex:1, color:C.text, fontSize:10, paddingVertical:8 },
  row:{ minHeight:49, borderTopWidth:StyleSheet.hairlineWidth, borderTopColor:C.border, flexDirection:"row", alignItems:"center", gap:8 },
  image:{ width:28, height:28 },
  fallback:{ width:28, height:28, borderRadius:14, backgroundColor:C.raised, alignItems:"center", justifyContent:"center" },
  fallbackText:{ color:C.secondary, fontSize:9, fontWeight:"900" },
  flex:{ flex:1, minWidth:0 },
  name:{ color:C.secondary, fontSize:9.5, fontWeight:"800" },
  meta:{ color:C.muted, fontSize:8, marginTop:2 },
  type:{ color:C.muted, fontSize:7, fontWeight:"900" },
  warning:{ color:C.amber, fontSize:8.5, lineHeight:13, marginTop:8 },
  empty:{ color:C.muted, fontSize:9, marginTop:9 },
});

...
const s = StyleSheet.create({
  ...
  heroComp: { color: C.muted, fontSize: 10, fontWeight: "900", letterSpacing: 0.8, textAlign: "center" },
  heroKickoff: { color: C.text, fontSize: 12, fontWeight: "800", textAlign: "center", marginTop: 2 },
  heroVenue: { color: C.muted, fontSize: 9.5, textAlign: "center", marginTop: 2 },
  heroTeamsRow: { flexDirection: "row", alignItems: "center", marginTop: 12 },
  heroTeam: { flex: 1, alignItems: "center", gap: 6 },
  heroTeamText: { color: C.text, fontSize: 12, fontWeight: "800", textAlign: "center" },
  heroVsBlock: { width: 70, alignItems: "center" },
  heroVsText: { color: C.red, fontSize: 17, fontWeight: "900" },
  heroMatchState: { color: C.muted, fontSize: 8.5, fontWeight: "800", marginTop: 3 },
  fallbackMark: {
  ...
  stateTitle: { color: C.text, fontSize: 13, fontWeight: "800" },
  stateText: { color: C.text, fontSize: 12, fontWeight: "700" },
  stateSubtext: { color: C.muted, fontSize: 10, textAlign: "center" },
  qualityCard: {
    borderRadius: 14,
    backgroundColor: C.surface,
    borderWidth: 1,
  ...
  qualityEyebrow: { color: C.muted, fontSize: 8.5, fontWeight: "900", letterSpacing: 0.6 },
  qualityScore: { fontSize: 18, fontWeight: "900", marginLeft: 8 },
  qualityTitle: { color: C.text, fontSize: 12.5, fontWeight: "800", marginTop: 6 },
  qualityMessage: { color: C.secondary, fontSize: 10, lineHeight: 15, marginTop: 4 },
  qualityMeta: { color: C.muted, fontSize: 8.5, marginTop: 6 },
  articleCard: {
    borderRadius: 14,
    backgroundColor: C.surface,
    borderWidth: 1,
  ...
  articleHeaderTitle: { color: C.red, fontSize: 9.5, fontWeight: "900", letterSpacing: 0.8 },
  articleBody: { color: C.secondary, fontSize: 12, lineHeight: 20, letterSpacing: 0.2 },
  sectionsWrap: { marginBottom: 12 },
  sectionsHeader: { color: C.muted, fontSize: 9.5, fontWeight: "900", letterSpacing: 0.8, marginBottom: 8 },
  sectionCard: {
    borderRadius: 12,
    backgroundColor: C.surface,
    borderWidth: 1,
  ...
  sectionTitle: { color: C.text, fontSize: 11.5, fontWeight: "800" },
  statusBadge: { fontSize: 8, fontWeight: "900", borderWidth: 1, borderRadius: 4, paddingHorizontal: 4, paddingVertical: 1 },
  factRow: {
    flexDirection: "row",
    alignItems: "center",
  ...
  factLabel: { color: C.muted, fontSize: 10, flex: 1 },
  factValue: { color: C.text, fontSize: 10.5, fontWeight: "700" },
  emptySectionText: { color: C.muted, fontSize: 9.5, fontStyle: "italic", marginTop: 4 },
  ...
  predictionEyebrow: { color: C.amber, fontSize: 8.5, fontWeight: "900", letterSpacing: 0.7 },
  predictionText: { color: C.secondary, fontSize: 11, fontWeight: "700", marginTop: 4 },
  ...
  matchCenterBtnText: { color: C.text, fontSize: 10.5, fontWeight: "900", letterSpacing: 0.5 },
  websiteBtn: {
    minHeight: 42,
    borderRadius: 10,
    backgroundColor: C.surface,
  ...
  websiteBtnText: { color: C.secondary, fontSize: 10, fontWeight: "700" },
});

...
const s = StyleSheet.create({
  ...
  statusText: { color: C.secondary, fontSize: 10.5, lineHeight: 15, flex: 1 },
  avatarCard: {
    borderRadius: 14,
    backgroundColor: C.surface,
    borderWidth: 1,
  ...
  previewBadgeText: { color: C.text, fontSize: 7.5, fontWeight: "900", letterSpacing: 0.5 },
  ...
  chooseBtnText: { color: C.text, fontSize: 10.5, fontWeight: "800" },
  ...
  saveAvatarText: { color: C.text, fontSize: 10, fontWeight: "900" },
  cancelPendingBtn: {
    minHeight: 36,
    borderRadius: 8,
    backgroundColor: C.raised,
  ...
  cancelPendingText: { color: C.muted, fontSize: 10, fontWeight: "700" },
  removeAvatarBtn: { paddingVertical: 4 },
  removeAvatarText: { color: C.muted, fontSize: 10, textDecorationLine: "underline" },
  formCard: {
    borderRadius: 14,
    backgroundColor: C.surface,
    borderWidth: 1,
  ...
  formHeader: { color: C.muted, fontSize: 9.5, fontWeight: "900", letterSpacing: 0.8, marginBottom: 12 },
  inputLabel: { color: C.secondary, fontSize: 10.5, fontWeight: "800", marginBottom: 6 },
  input: {
    minHeight: 42,
    borderRadius: 8,
    backgroundColor: C.raised,
  ...
  inputDisabledText: { color: C.muted, fontSize: 10.5 },
  accountStatusRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  accountStatusText: { color: C.muted, fontSize: 9.5, flex: 1 },
  saveChangesBtn: {
    minHeight: 42,
    borderRadius: 8,
    backgroundColor: C.red,
  ...
  saveChangesText: { color: C.text, fontSize: 10.5, fontWeight: "900", letterSpacing: 0.5 },
});

...
const s = StyleSheet.create({
  ...
  eyebrow: { color: C.red, fontSize: 11, fontWeight: "900", letterSpacing: 0.9 },
  heading: { color: C.text, fontSize: 20, fontWeight: "900", marginTop: 3 },
  refreshButton: { minHeight: 38, flexDirection: "row", alignItems: "center", gap: 6, borderRadius: 9, borderWidth: 1, borderColor: C.border, backgroundColor: C.raised, paddingHorizontal: 12 },
  refreshText: { color: C.secondary, fontSize: 12.5, fontWeight: "900" },
  ...
  category: { flex: 1, color: C.red, fontSize: 11, fontWeight: "900", letterSpacing: 0.7 },
  date: { color: C.muted, fontSize: 11.5 },
  title: { color: C.text, fontSize: 16, lineHeight: 22, fontWeight: "900", marginTop: 7 },
  excerpt: { color: C.secondary, fontSize: 13.5, lineHeight: 19, marginTop: 7 },
  readRow: { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 10 },
  readText: { color: C.red, fontSize: 12.5, fontWeight: "900" },
  ...
  retryButton: { minHeight: 38, justifyContent: "center", borderRadius: 9, backgroundColor: C.red, paddingHorizontal: 16, marginTop: 4 },
  retryText: { color: C.text, fontSize: 13, fontWeight: "900" },
});
